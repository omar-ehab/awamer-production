        ...
        <div class="panel panel-default col-sm-12  ">
            ...
            <div class="panel-heading col-sm-12 row" style="padding: 0px;background: red;">
                <div class="panel-body col-sm-12 row" style=" background: #2381c6;color: #fff;padding:  20px 5px; ">
                    ...
                    <div class="col-sm-6 " style="padding: 4px">
                        <span class="fa fa-user" style="color: var(--orange-light-color);margin-right: 10px;padding-left: 20px;font-size: 22px;"></span>  ايقاف متبرع
                    </div>
                    <div class="col-sm-6  text-right" style="padding: 0px;display: unset;">
                        <button></button>
                        <button class="btn btn-success  " style="padding: 3px 8px ;border-radius: 0px;background: transparent;border:1px solid #39fbed;margin: 0px 2px;"  onclick="$('#submit').submit();">إيقاف <span class="fa fa-check"></span></button>
                    </div>
            ...
            <div class="panel-body col-12 row" style="padding: 0px; background: ">
                ...
                <div class="col-sm-12 " style=" padding: 0px 5px; ">
                    <h1 style="margin-top: 20px">برجاء ذكر سبب إيقاف المتبرع:  {{ $donor->name }}</h1>
                    <form action="{{ route('donors.stop', $donor->id) }}" method="POST" id="submit">
                        {{csrf_field()}}
