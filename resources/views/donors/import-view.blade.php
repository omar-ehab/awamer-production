      ...
      <div class="panel-heading col-sm-12 row" style="padding: 0px;background: red;">
            <div class="panel-body col-sm-12 row" style=" background: #2381c6;color: #fff;padding:  20px 5px; ">
                ...
                <div class="col-sm-6 " style="padding: 4px">
                    <span class="fa fa-user" style="color: var(--orange-light-color);margin-right: 10px;padding-left: 20px;font-size: 22px;"></span>  إستيراد متبرعين
                </div>
                <div class="col-sm-6  text-right" style="padding: 0px;display: unset;">
                    <button></button>
                    <a href="/system_excel_templates/اضافة متبرع.xlsx">
                    <span class="btn btn-info  " style="padding: 3px 8px ;border-radius: 0px; border:1px solid #39fbed;margin: 0px 2px;"  >تحميل النموزج <span class="fa fa-download"></span></span>
                    </a>
        ...
        <div class="panel-body col-12 row" style="padding: 0px; background: ">
              ...
              <div class="col-sm-12 " style=" padding: 0px 5px; ">
                <form action="{{ route('donors.import') }}" method="POST" id="submit" enctype="multipart/form-data">
                   {{csrf_field()}}
