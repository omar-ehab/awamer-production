            ...
            <div class="panel-heading  col-12" style="padding: 0px; ">
                <div class="panel-body col-12 row " style=" background: #2381c6;color: #fff;padding:  20px 5px; ">
                    <div class="col-6 " style="padding: 4px">
                        <span class="fa fa-clock" style="color: var(--orange-light-color);margin-right: 10px;padding-left: 20px;font-size: 22px;"></span>  سنادات قبض لفترة
                    </div>
                    <div class="col-6  text-right" style="padding: 0px;display: unset;direction: ltr">
                        <button></button>
                        <a href="{{ route('sanads.IntervalReceivableSanadCreate') }}">
                    ...
                    <table id="myTable" class="table table-striped table-bordered col-xs-12" style="width:100%;padding: 0px;">
                        ...
                        @foreach($sanads as $sanad)
                            ...
                            <tr>
                                ...
                                <td>{{$sanad->total_amount}}</td>
                                <td>{{$sanad->process_number}}</td>
                                <td>{{$sanad->employee->name}}</td>


                                <td style="max-width: 100px">
                                    <a href="{{ route('sanads.IntervalReceivableSanadPrint', $sanad->id) }}" target="_blank" data-toggle="tooltip" data-placement="bottom" title="طباعة">
