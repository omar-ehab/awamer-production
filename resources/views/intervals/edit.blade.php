      ...
      <div class="panel-heading col-sm-12 row" style="padding: 0px;background: red;">
            <div class="panel-body col-sm-12 row" style=" background: #2381c6;color: #fff;padding:  20px 5px; ">
                ...
                <div class="col-sm-6 " style="padding: 4px">
                    <span class="fa fa-user" style="color: var(--orange-light-color);margin-right: 10px;padding-left: 20px;font-size: 22px;"></span>   تعديل
                </div>
        ...
        <div class="panel-body col-12 row" style="padding: 0px; background: ">
              ...
              <div class="col-sm-12 " style=" padding: 0px 5px; ">
                <form action="{{ route('intervals.update', $interval->id) }}" method="POST" id="submit">
                   {{csrf_field()}}
                   {{ method_field('PATCH') }}
                          ...
                          <div class="col-sm-12 col-md-6  " style="border:none">
                              ...
                              <div class="col-sm-12 col-lg-10" style="padding: 20px 5px;padding-top: 60px">
                                  ...
                                  <div class="col-sm-12 row" style="padding: 6px;">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" name="name" class="form-control" value="{{$interval['name']}}" autofocus="">
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-sm-12 row" style="padding: 6px;">
                                      ...
                                      <div class="col-sm-9">
                                          <input type='text' class="dp-peter form-control" data-position="left top" name="start" value="{{ $interval->start }}"/>
                                  ...
                                  <div class="col-sm-12 row" style="padding: 6px;">
                                      ...
                                      <div class="col-sm-9">
                                          <input type='text' class="dp-peter form-control" data-position="left top" name="end" value="{{ $interval->end }}"/>
                                          <!--http://t1m0n.name/air-datepicker/docs/-->
                                      </div>
                                  </div>
