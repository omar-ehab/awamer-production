      ...
      <div class="panel-heading col-sm-12 row" style="padding: 0px;background: red;">
        ...
        <div class="panel-body col-12 row" style="padding: 0px; background: ">
              ...
              <div class="col-sm-12 " style=" padding: 0px 5px; ">
                <form action="{{ route('banks.update', $bank->id) }}" method="POST" id="submit">
                    {{csrf_field()}}
                    {{ method_field('PATCH') }}
                          ...
                          <div class="col-sm-12 col-md-6  " style="border:none">
                              ...
                              <div class="col-sm-12 col-lg-10" style="padding: 20px 5px;padding-top: 60px">
                                  ...
                                  <div class="col-sm-12 row" style="padding: 6px;">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" name="name" class="form-control" value="{{$bank['name']}}" autofocus="">
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-sm-12 row" style="padding: 6px;">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" name="donation_date_col" class="form-control" value="{{chr($bank['donation_date_col']+65)}}" autofocus=""  placeholder="مثال A او B او C ...">
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-sm-12 row" style="padding: 6px;">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" name="amount_col" class="form-control" value="{{chr($bank['amount_col']+65)}}" autofocus=""  placeholder="مثال A او B او C ...">
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-sm-12 row" style="padding: 6px;">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" name="bank_account_number_col" class="form-control" value="{{chr($bank['bank_account_number_col']+65)}}" autofocus="" placeholder="مثال A او B او C ...">
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-sm-12 row" style="padding: 6px;">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" name="read_from_row" class="form-control" value="{{$bank['read_from_row']}}" autofocus="" placeholder="مثال 1 او 2 او 3 ...">
                                      </div>
                                  </div>
