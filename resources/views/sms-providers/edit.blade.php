      ...
      <div class="panel-heading col-sm-12 row" style="padding: 0px;background: red;">
            <div class="panel-body col-sm-12 row" style=" background: #2381c6;color: #fff;padding:  20px 5px; ">
                ...
                <div class="col-sm-6 " style="padding: 4px">
                    <span class="fa fa-envelope" style="color: var(--orange-light-color);margin-right: 10px;padding-left: 20px;font-size: 22px;"></span> تعديل بيانات مزود خدمة SMS
                </div>
        ...
        <div class="panel-body col-12 row" style="padding: 0;">
              ...
              <div class="col-sm-12 " style=" padding: 0px 5px; ">
                <form action="{{route('sms-providers.update', $sms_provider->id)}}" method="POST" id="submit">
                   @csrf
                   @method('PUT')
                          ...
                          <div class="col-sm-12 col-md-6  " style="border:none">
                              ...
                              <div class="col-sm-12 col-lg-10" style="padding: 20px 5px;padding-top: 60px">
                                  ...
                                  <div class="col-sm-12 row" style="padding: 6px;">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" name="provider_name" class="form-control" value="{{ $sms_provider['provider_name'] }}" autofocus="">
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-sm-12 row" style="padding: 6px;">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" name="username" class="form-control" value="{{ $sms_provider['username'] }}" autofocus="">
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-sm-12 row" style="padding: 6px;">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" name="password" class="form-control" value="{{ $sms_provider['password'] }}" autofocus="">
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-sm-12 row" style="padding: 6px;">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" name="token" class="form-control" value="{{ $sms_provider['token'] }}" autofocus="">
                                      </div>
                                  </div>
