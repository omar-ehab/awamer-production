      ...
      <div class="panel-heading col-sm-12 row" style="padding: 0px;background: red;">
        ...
        <div class="panel-body col-12 row" style="padding: 0px; background: ">
              ...
              <div class="col-sm-12 " style=" padding: 0px 5px; ">
                <form action="{{ route('bank-accounts.update', $bank_account->id) }}" method="POST" id="submit">
                   {{csrf_field()}}
                   {{ method_field('PATCH') }}
                              ...
                              <div class="col-sm-12 col-lg-10" style="padding: 20px 5px;padding-top: 60px">
                                  ...
                                  <div class="col-sm-12 row" style="padding: 6px;">
                                      ...
                                      <div class="col-sm-9">
                                        <select class="form-control" name="bank_id">
                                          @foreach($banks as $bank)
                                            <option value="{{$bank->id}}" @if($bank_account['bank_id']==$bank->id)selected=""@endif >{{$bank->name}}</option>
                                          @endforeach
                                        </select>
                                   ...
                                   <div class="col-sm-12 row" style="padding: 6px;">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" name="account_number" class="form-control" value="{{$bank_account['account_number']}}" >
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-sm-12 row" style="padding: 6px;">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" name="iban" class="form-control" value="{{$bank_account['iban']}}" >
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-sm-12 row" style="padding: 6px;">
                                      ...
                                      <div class="col-sm-9">
                                          <textarea type="text" name="description" class="form-control"  >{{$bank_account['description']}}</textarea>
                                      </div>
                                  </div>
                              </div>
